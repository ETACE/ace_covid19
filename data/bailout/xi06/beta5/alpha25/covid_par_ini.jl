...
#policy data
pspar = 0.25 # reduction in pshop after opening
tpol = virustime + 21
tpolout = tpol + 21

policies = Dict{Int64,String}()
policies[tpol] = "policy_bailout_alpha.jl"
...
adaptivepolicybad = "policy_bailout_alpha.jl" #  policy activated if number of infected below threshold
