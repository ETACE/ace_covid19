...
policies[tpol] = "policy_ind_prev_measures_wfh.jl"
...
adaptivepolicythresholdon = 0 * nhh / (detfrac*100000) # Threshold infected/week
poladjfrac = 0.6 # factor by which gap in policy parameter is closeed during phase in / phase out every week

tadaptivepolicystart = 99999 # DO NOT Enable adaptive policy response
tadaptivepolicyend = vacctime - 7 # Enable adaptive policy response
adaptivepolicygood = "" # policy acitvated if number of infected above threshold
adaptivepolicybad = "" #  policy activated if number of infected below threshold
...
ptravel = 0.0 # prob of being in other region, only for young
