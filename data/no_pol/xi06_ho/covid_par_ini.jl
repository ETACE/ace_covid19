...
adaptivepolicythreshold = 0 * nhh / (detfrac*100000) # Threshold infected/week
poladjfrac = 0.6 # factor by which gap in policy parameter is closeed during phase in / phase out every week

tadaptivepolicystart = virustime + 21 # Enable adaptive policy response
...
adaptivepolicybad = "policy_only_xi_ho.jl" #  policy activated if number of infected below threshold
