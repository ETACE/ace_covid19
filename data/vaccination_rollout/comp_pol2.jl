...
plotname_prefix = "" # store the plots here
...
include("beta_l50_60//covid_par_ini.jl") # necessary for some basic parameter values (nhh)
...
scatter!([point_C_100_x+0.12], [point_C_100_y+0.003], markersize = 0, markercolor = [:white], series_annotations = text.(["100%"], :top, 5))
...
savefig(plfull,"$(plotname_prefix)pol_comp2.pdf")
