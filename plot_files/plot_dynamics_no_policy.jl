...
# parameter values
paras = ["no_measures","ind_prev_measures","ind_prev_measures_wfh"]
# paras = ["no_pol","dist","dist_ho"]

filename_prefix = "../figures/dynamics_no_policy_"
path_to_data = "../data/mutation_no_policy/"
...
savefig(pl9,"$(filename_prefix)casualties.pdf")
...
ylims!(0.035,0.055)
savefig(pl11,"$(filename_prefix)unemployment.pdf")
